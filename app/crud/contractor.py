...
def sync_contractor_capacities(
    ...
    *,
    ...
    use_distributed_lock = getattr(cache_client, "distributed_lock_available", True)
    lock_acquired = not use_distributed_lock or cache_client.set_lock_json(lock_key, lock_value, expire_seconds=900, nx=True)
