...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("pre_repair_data", JSONB, nullable=False, server_default=sa.text("'{}'"), comment="修前关键数据JSONB"),
        sa.Column("post_repair_data", JSONB, nullable=False, server_default=sa.text("'{}'"), comment="修后关键数据JSONB"),
